...
| --sysconfdir        | /etc                          | /etc/zm                |                                                                                   |
| --with-cgidir       | /srv/http/cgi-bin             | /usr/lib/cgi-bin       | ZM_CGIDIR <prefix>/libexec/zoneminder/cgi-bin                                     |
...
|                     |                               |                        |                                                                                   |
|                     |                               |                        | ZM_CONTENTDIR  (events and images), default: /var/lib/zoneminder                  |
|                     |                               |                        | ZM_DB_HOST localhost                                                              |
|                     |                               |                        | ZM_DB_NAME zm                                                                     |
|                     |                               |                        | ZM_DB_USER zmuser                                                                 |
|                     |                               |                        | ZM_DB_PASS zmpass                                                                 |
|                     |                               |                        |                                                                                   |
|                     |                               |                        | ZM_WEB_GROUP The group apache runs on, Leave empty to be the same as the web user |
|                     |                               |                        |                                                                                   |
Advanced:
